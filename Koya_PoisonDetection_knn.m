...
%%%% KNN Classifier if we want to use it later
Mdl1 = fitcknn(training_data1(:,1:end-1),training_data1(:,end),'OptimizeHyperparameters','all','HyperparameterOptimizationOptions',struct('Verbose',0,'ShowPlots',0));
Mdl2 = fitcknn(training_data2(:,1:end-1),training_data2(:,end),'OptimizeHyperparameters','all','HyperparameterOptimizationOptions',struct('Verbose',0,'ShowPlots',0));
Mdl3 = fitcknn(training_data3(:,1:end-1),training_data3(:,end),'OptimizeHyperparameters','all','HyperparameterOptimizationOptions',struct('Verbose',0,'ShowPlots',0));
Mdl4 = fitcknn(training_data4(:,1:end-1),training_data4(:,end),'OptimizeHyperparameters','all','HyperparameterOptimizationOptions',struct('Verbose',0,'ShowPlots',0));
Mdl5 = fitcknn(training_data5(:,1:end-1),training_data5(:,end),'OptimizeHyperparameters','all','HyperparameterOptimizationOptions',struct('Verbose',0,'ShowPlots',0));
